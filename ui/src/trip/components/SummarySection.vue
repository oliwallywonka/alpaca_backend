  ...
  <section class="grid md:grid-cols-2 lg:grid-cols-4 gap-2">
    <Card>
      <CardContent class="grid gap-1">
        <span class="text-sm text-black/60">Total Payments:</span>
        <div class="flex gap-2">
          <span class="text-xl font-semibold">USD 4.250</span>
          <Badge variant="green">40% <ArrowUpRight class="text-green-500" /></Badge>
        </div>
        <span class="text-sm text-black/60">USD 1243 Left</span>
      </CardContent>
    </Card>

    <Card>
      <CardContent class="grid gap-1">
        <span class="text-sm text-black/60">Total Expenses:</span>
        <div class="flex gap-2">
          <span class="text-xl font-semibold">USD 4.250</span>
          <Badge variant="red">+10% <ArrowDownLeft /></Badge>
        </div>
        <span class="text-sm text-black/60">USD 150 Left</span>
      </CardContent>
    </Card>
    <Card>
      <CardContent class="grid gap-1">
        <span class="text-sm text-black/60">Total Revenue:</span>
        <div class="flex gap-2">
          <span class="text-xl font-semibold">USD 465</span>
